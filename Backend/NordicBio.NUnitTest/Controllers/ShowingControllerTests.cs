...
namespace NordicBio.NUnitTest
{
    ...
    {
        [TestCase("showing", HttpStatusCode.OK, TestName = "Get - Check status code is (OK)")]
        ...
        [TestCase("showing", "application/json; charset=utf-8", TestName = "Get - Check content type is (application/json)")]

...
Endvidere vil gruppens overvejelser i forhold til arkitektur og risikohåndtering blive dokumenteret. \\

Som elektronisk bilag til begge rapporter, er det biograf booking system som gruppen har udviklet. Til udviklingen af systemet er følgende værktøjer blevet brugt:

\begin{itemize}
    \item C\# til back-end programmering, og HTML5, CSS, JavaScript og VueJs til front-end.
